...
var ScrollView = function ScrollView(_ref) {
  ...
  var _useState = React.useState(Mitt__default['default']),
  ...
  }, children), /*#__PURE__*/React__default['default'].createElement(Scrollbar, {
...
var Scrollbar = function Scrollbar(_ref2) {
  ...
  var cursorDown = React.useRef(false);
  var cursorLeave = React.useRef(false);
  ...
  var startDrag = React.useCallback(function (e, thumbMouseOffset) {
  ...
  var handleThumbMouseDown = useEventCallback.useEventCallback(function (e) {
    var _context;

    e.nativeEvent.stopImmediatePropagation();
    e.stopPropagation();

    if (e.ctrlKey || _includesInstanceProperty__default['default'](_context = [1, 2]).call(_context, e.button)) {
      return;
    }
  ...
  var handleBarMouseDown = useEventCallback.useEventCallback(function (e) {
    var _context2;

    e.nativeEvent.stopImmediatePropagation();
    e.stopPropagation(); // middle click and right click won't trigger drag

    if (e.ctrlKey || _includesInstanceProperty__default['default'](_context2 = [1, 2]).call(_context2, e.button)) {
      return;
    }
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: clsx_m.clsx('st-scrollbar', vertical ? 'st-scrollbar--vertical' : 'st-scrollbar--horizontal', visible && 'st-scrollbar--visible'),
    ref: barRef
  }, /*#__PURE__*/React__default['default'].createElement("div", {
...
function renderThumbStyle(_ref3) {
  ...
  var translate = _concatInstanceProperty__default['default'](_context3 = "translate".concat(xy.axis, "(")).call(_context3, move, "%)");

  return _ref4 = {}, _defineProperty__default['default'](_ref4, xy.size, size), _defineProperty__default['default'](_ref4, "transform", translate), _ref4;
}
