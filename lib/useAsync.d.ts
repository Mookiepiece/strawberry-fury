...
export declare function useAsyncFn<T extends FunctionReturningPromise>(...paramsz: Parameters<typeof _useAsyncFn>): [AsyncFnReturn<T>[0], (...params: Parameters<T>) => void];
