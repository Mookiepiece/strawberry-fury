...
var registry = [];
var ModalMitt = starfallUtils.Mitt();
...
ModalMitt.on('UNREGISTER', function (id) {
  return Modal.registry = registry = starfallUtils.horizon.remove(registry, function (i) {
    return i === id;
  });
});
var uuid = 1;
...
var Modal = function Modal(props) {
  ...
  var ecOnClose = starfallUtils.useEventCallback(onClose || noop);
  React.useEffect(function () {
  ...
  return /*#__PURE__*/React__default['default'].createElement(starfallUtils.Portal, null, /*#__PURE__*/React__default['default'].createElement(reactTransitionGroup.CSSTransition, {
    timeout: 300,
    "in": visible,
  ...
  }, title), closable ? /*#__PURE__*/React__default['default'].createElement(Button.Button, {
    textual: true,
